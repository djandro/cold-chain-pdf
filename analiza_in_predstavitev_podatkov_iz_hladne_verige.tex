...
% todo naredi tabelo v dve strani
...
Na sliki~\ref{ss-record-page-sl} v zgornjem odseku zaslonskega posnetka vidimo, da se graf dobe uporabnosti nanaša na živilo svinina (\sn{Shelf Life (SL) for product Svinina}), ki ima priporočeno temperaturo hranjenja med 0 in 4 stopinje Celzija (\sn{Storage T (°C)}) in referenčno dobo uporabnosti 11 dni (\sn{SL-Reference (Days)}).
